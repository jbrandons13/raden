...
- [x] **Pesanan/Riwayat dikelompokkan per tanggal** (header + jumlah transaksi + total harian); eceran/kasir tanpa nama → label **"Pembeli Eceran"** (bukan "Tanpa Nama"); badge **channel · metode bayar** (mis. "Eceran · Cash") biar history kasir kebaca.
