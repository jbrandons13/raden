...
- [x] **Penjualan Toko** (`/admin/kasir`): halaman khusus penjualan kasir/eceran — **box per hari** (tanggal + total + jumlah trx), tiap transaksi: jam · pembeli · metode bayar · item · nominal. Filter periode (Hari Ini/7/30/Semua) + Export Excel. **Pesanan kini distribusi-only** (branch/agen) — retail pindah ke sini.
